...
public class TransformWrapper implements Transform
{
    ...
    @Override
    public Op transform(OpFuseJoin opFuseJoin, Op subOp)            { return transform.transform(opFuseJoin, subOp); }
    @Override
    public Op transform(OpSimilarityJoin opSimJoin, Op subOp)       { return transform.transform(opSimJoin, subOp); }
